(function () {
    ...
    angular
        .module("onePOS.login")
        .controller("passwordResetCtrl", ["$state", "loginService", 'AuthService', "constants", 'logger',
            passwordResetCtrl]);

    function passwordResetCtrl($state, loginService, AuthService, constants, logger) {
        ...
        vm.lightMessage = "Eine TAN wurde auf Ihr Handy geschickt. Geben Sie sie bitte ein.";

        credentials.username = AuthService.getUser().puid;
